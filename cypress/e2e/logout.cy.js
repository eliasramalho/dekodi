...
describe('Validar funcionalidade logout', () => {
    ...
    beforeEach(() => {
        cy.visit('/')
        cy.get('#mat-input-0').type('vocik67237@tsderp.com')
    ...
    it('logout com quesionario em andamento ', () => {
        ...
        cy.deslogar().wait(2000)
        cy.get('#mat-input-3').type('vocik67237@tsderp.com')
    ...
    it('logout apos editar nome do usuario', () => {
        ...
        cy.get('#mat-input-13').type('vocik67237@tsderp.com')
    ...
    describe('novo usuario', () => {
        ...
        beforeEach(() => {
            cy.visit('/')
            cy.get('#mat-input-0').type('medeva6874@trackden.com')
            cy.get('#mat-input-1').type('P@ssw0rd')
        ...
        it('empresa ja cadastrada', () => {
            ...
            cy.get('.mat-mdc-menu-content > :nth-child(9)').click().wait(1000)
            cy.get('#mat-input-13').type('medeva6874@trackden.com')
            cy.get('#mat-input-14').type('P@ssw0rd')
            cy.contains('button', 'Entrar').click().wait(2000)
            cy.editarDados()
